...
/**
 * 
 * Action para excluir um Tipo de Treinamento Tático.
 * 
...
@Controller
@Scope("request")
public class TipoTreinamentoTaticoExcluirJsonAction extends ActionSupport {
	...
	public String excluir() {
		configuracaoServiceFacade.excluirTipoTreinamentoTatico(tipoTreinamentoTatico);
		return SUCCESS;
	}
