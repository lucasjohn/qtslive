...
<body>
	...
	<div class="panel panel-white">
		...
		<div class="panel-body">
			<button id="novo-registro-button" type="button" class="btn btn-primary btn-addon m-b-sm" data-toggle="modal" data-target="#modalNovoRegistro"> Novo Perfil </button>
	...
	<content tag="local_script">
		...
		<script>
			...
			$(document).ready(function() {
				...
				$('#add-row').click(function () {
					...
					if($("#add-row-form").isValid()) {
			            ...
			            var params = "?perfil.nome="+nome+"&perfil.idClube="+idClube;
			            
			            //Envia a requisição
			            $.ajax({
			                type: "POST",
			                url: 'criarPerfilJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
			                	var id = data.perfil.id;			                	
			                	var idClube = data.perfil.idClube;
				                var nome = data.perfil.nome;	
				...
				$('#update-row').click(function () {					
					...
					if($("#update-row-form").isValid()) {
			            ...
			            var params = "?perfil.nome="+nome+"&perfil.idClube="+idClube+"&perfil.id="+id;
			            
			            $.ajax({
			                type: "POST",
			                url: 'editarPerfilJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
				...
				$('#delete-row').click(function () {					
			            ...
			            var params = "?perfil.idClube="+idClube+"&perfil.id="+id;
			            
			            $.ajax({
			                type: "POST",
			                url: 'excluirPerfilJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
			...
			function iniciarDeleteRegistro(id, idClube, nome) {	
				...
				$('#msg-alerta-excluir-div').html('<div class="alert alert-warning" role="alert">Excluir o perfil "<b>'+nome+'</b>"?</div>');
