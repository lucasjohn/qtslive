...
<body>
	...
	<div class="panel panel-white">
		...
		<div class="panel-heading clearfix">
			<h4 class="panel-title">Local de Dor</h4>
		</div>
		<div class="panel-body">
			<button id="novo-registro-button" type="button" class="btn btn-primary btn-addon m-b-sm" data-toggle="modal" data-target="#modalNovoRegistro"> Novo Local de Dor </button>
	                ...
	                <div class="modal-dialog">
	                    <div class="modal-content">
	                        <div class="modal-header">
	                            ...
	                            <h4 class="modal-title" id="myModalLabel">Adicionar Local de Dor</h4>
	                        </div>
	            ...
	            <div style="display: none;" class="modal fade" id="editar-registro-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	                <div class="modal-dialog">
	                    <div class="modal-content">
	                        <div class="modal-header">
	                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
	                            <h4 class="modal-title" id="myModalLabel">Alterar Local de Dor</h4>
	                        </div>
	                        <div class="modal-body">
<!--                         		<div class="row"> -->
<!-- 	                        		<div class="col-sm-5"> -->
            ...
            <div style="display: none;" class="modal fade" id="delete-registro-modal" tabindex="-1" role="dialog alert" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                            <h4 class="modal-title" id="myModalLabel">Excluir Local de Dor</h4>
                        </div>
                        <div class="modal-body">
	...
	<content tag="local_script">
		...
		<script>
			...
			$(document).ready(function() {
				...
				$('#add-row').click(function () {
					...
					if($("#add-row-form").isValid()) {
			            ...
			            var params = "?localDor.nome="+nome+"&localDor.idClube="+idClube;
			            
			            //Envia a requisição
			            $.ajax({
			                type: "POST",
			                url: 'criarLocalDorJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
			                	var id = data.localDor.id;			                	
			                	var idClube = data.localDor.idClube;
				                var nome = data.localDor.nome;	
				...
				$('#update-row').click(function () {					
					...
					if($("#update-row-form").isValid()) {
			            ...
			            var params = "?localDor.nome="+nome+"&localDor.idClube="+idClube+"&localDor.id="+id;
			            
			            $.ajax({
			                type: "POST",
			                url: 'editarLocalDorJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
				...
				$('#delete-row').click(function () {					
			            ...
			            var params = "?localDor.idClube="+idClube+"&localDor.id="+id;
			            
			            $.ajax({
			                type: "POST",
			                url: 'excluirLocalDorJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
			...
			function iniciarDeleteRegistro(id, idClube, nome) {	
				...
				$('#msg-alerta-excluir-div').html('<div class="alert alert-warning" role="alert">Excluir o Local de Dor "<b>'+nome+'</b>"?</div>');
