...
<body>
	...
	<div class="panel panel-white">
		...
		<div class="panel-heading clearfix">
			<h4 class="panel-title">Especial</h4>
		</div>
		<div class="panel-body">
			<button id="novo-registro-button" type="button" class="btn btn-primary btn-addon m-b-sm" data-toggle="modal" data-target="#modalNovoRegistro"> Novo Especial </button>
	                ...
	                <div class="modal-dialog">
	                    <div class="modal-content">
	                        <div class="modal-header">
	                            ...
	                            <h4 class="modal-title" id="myModalLabel">Adicionar Especial</h4>
	                        </div>
	            ...
	            <div style="display: none;" class="modal fade" id="editar-registro-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	                <div class="modal-dialog">
	                    <div class="modal-content">
	                        <div class="modal-header">
	                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
	                            <h4 class="modal-title" id="myModalLabel">Alterar Especial</h4>
	                        </div>
	                        <div class="modal-body">
<!--                         		<div class="row"> -->
<!-- 	                        		<div class="col-sm-5"> -->
            ...
            <div style="display: none;" class="modal fade" id="delete-registro-modal" tabindex="-1" role="dialog alert" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                            <h4 class="modal-title" id="myModalLabel">Excluir Especial</h4>
                        </div>
                        <div class="modal-body">
	...
	<content tag="local_script">
		...
		<script>
			...
			$(document).ready(function() {
				...
				$('#add-row').click(function () {
					...
					if($("#add-row-form").isValid()) {
			            ...
			            var params = "?especial.nome="+nome+"&especial.idClube="+idClube;
			            
			            //Envia a requisição
			            $.ajax({
			                type: "POST",
			                url: 'criarEspecialJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
			                	var id = data.especial.id;			                	
			                	var idClube = data.especial.idClube;
				                var nome = data.especial.nome;	
			                	...
			                	toastr["success"]("O Especial "+nome+" foi criado com sucesso.");
			                }
				...
				$('#update-row').click(function () {					
					...
					if($("#update-row-form").isValid()) {
			            ...
			            var params = "?especial.nome="+nome+"&especial.idClube="+idClube+"&especial.id="+id;
			            
			            $.ajax({
			                type: "POST",
			                url: 'editarEspecialJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
				            	...
				            	toastr["success"]("O Especial "+nome+" foi atualizado com sucesso.");
			                }
				...
				$('#delete-row').click(function () {					
			            ...
			            var params = "?especial.idClube="+idClube+"&especial.id="+id;
			            
			            $.ajax({
			                type: "POST",
			                url: 'excluirEspecialJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
			                	toastr["success"]("O Especial foi excuído com sucesso.");
			                }
			...
			function iniciarDeleteRegistro(id, idClube, nome) {	
				...
				$('#msg-alerta-excluir-div').html('<div class="alert alert-warning" role="alert">Excluir o Especial "<b>'+nome+'</b>"?</div>');
