...
<body>
	...
	<div class="panel panel-white">
		...
		<div class="panel-body">
			<button id="novo-registro-button" type="button" class="btn btn-primary btn-addon m-b-sm" data-toggle="modal" data-target="#modalNovoRegistro"> Novo Período </button>
	...
	<content tag="local_script">
		...
		<script>
			...
			$(document).ready(function() {
				...
				$('#add-row').click(function () {
					...
					if($("#add-row-form").isValid()) {
			            ...
			            var params = "?periodo.nome="+nome+"&periodo.idClube="+idClube;
			            
			            //Envia a requisição
			            $.ajax({
			                type: "POST",
			                url: 'criarPeriodoJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
			                	var id = data.periodo.id;			                	
			                	var idClube = data.periodo.idClube;
				                var nome = data.periodo.nome;	
				...
				$('#update-row').click(function () {					
					...
					if($("#update-row-form").isValid()) {
			            ...
			            var params = "?periodo.nome="+nome+"&periodo.idClube="+idClube+"&periodo.id="+id;
			            
			            $.ajax({
			                type: "POST",
			                url: 'editarPeriodoJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
				...
				$('#delete-row').click(function () {					
			            ...
			            var params = "?periodo.idClube="+idClube+"&periodo.id="+id;
			            
			            $.ajax({
			                type: "POST",
			                url: 'excluirPeriodoJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
			...
			function iniciarDeleteRegistro(id, idClube, nome) {	
				...
				$('#msg-alerta-excluir-div').html('<div class="alert alert-warning" role="alert">Excluir o Período "<b>'+nome+'</b>"?</div>');
