...
<title>QTS | Tipo Treinamento Tático</title>
...
<body>
	...
	<div class="panel panel-white">
		...
		<div class="panel-heading clearfix">
			<h4 class="panel-title">Tipo Treinamento Tático</h4>
		</div>
		<div class="panel-body">
			<button id="novo-registro-button" type="button" class="btn btn-primary btn-addon m-b-sm" data-toggle="modal" data-target="#modalNovoRegistro"> Novo Tipo Treinamento Tático </button>
	                ...
	                <div class="modal-dialog">
	                    <div class="modal-content">
	                        <div class="modal-header">
	                            ...
	                            <h4 class="modal-title" id="myModalLabel">Adicionar Tipo Treinamento Tático</h4>
	                        </div>
	            ...
	            <div style="display: none;" class="modal fade" id="editar-registro-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	                <div class="modal-dialog">
	                    <div class="modal-content">
	                        <div class="modal-header">
	                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
	                            <h4 class="modal-title" id="myModalLabel">Alterar Tipo Treinamento Tático</h4>
	                        </div>
	                        <div class="modal-body">
<!--                         		<div class="row"> -->
<!-- 	                        		<div class="col-sm-5"> -->
            ...
            <div style="display: none;" class="modal fade" id="delete-registro-modal" tabindex="-1" role="dialog alert" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                            <h4 class="modal-title" id="myModalLabel">Tipo Treinamento Tático</h4>
                        </div>
                        <div class="modal-body">
	...
	<content tag="local_script">
		...
		<script>
			...
			$(document).ready(function() {
				...
				$('#add-row').click(function () {
					...
					if($("#add-row-form").isValid()) {
			            ...
			            var params = "?tipoTreinamentoTatico.nome="+nome+"&tipoTreinamentoTatico.idClube="+idClube;
			            
			            //Envia a requisição
			            $.ajax({
			                type: "POST",
			                url: 'criarTipoTreinamentoTaticoJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
			                	var id = data.tipoTreinamentoTatico.id;			                	
			                	var idClube = data.tipoTreinamentoTatico.idClube;
				                var nome = data.tipoTreinamentoTatico.nome;	
				...
				$('#update-row').click(function () {					
					...
					if($("#update-row-form").isValid()) {
			            ...
			            var params = "?tipoTreinamentoTatico.nome="+nome+"&tipoTreinamentoTatico.idClube="+idClube+"&tipoTreinamentoTatico.id="+id;
			            
			            $.ajax({
			                type: "POST",
			                url: 'editarTipoTreinamentoTaticoJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
				...
				$('#delete-row').click(function () {					
			            ...
			            var params = "?tipoTreinamentoTatico.idClube="+idClube+"&tipoTreinamentoTatico.id="+id;
			            
			            $.ajax({
			                type: "POST",
			                url: 'excluirTipoTreinamentoTaticoJson'+params,			                
			                dataType: 'json',
			                contentType: 'application/json',
			                success: function(data) {
			...
			function iniciarDeleteRegistro(id, idClube, nome) {	
				...
				$('#msg-alerta-excluir-div').html('<div class="alert alert-warning" role="alert">Excluir o Tipo Treinamento Tático "<b>'+nome+'</b>"?</div>');
